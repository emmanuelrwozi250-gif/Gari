  ...
  return (
    <div className="card p-8">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 py-3 px-4 border-2 border-border rounded-xl text-sm font-medium text-text-primary dark:text-gray-200 hover:border-primary hover:bg-primary-light transition-all mb-4"
      >
      ...
      <div className="relative flex items-center mb-4">
        ...
        <span className="px-3 text-xs text-text-light bg-white dark:bg-gray-900">or continue with email</span>
        <div className="flex-1 border-t border-border" />
      </div>
    ...
    <div className="min-h-screen bg-gray-bg dark:bg-gray-950 flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-text-secondary mt-1">Sign in to your Gari account</p>
        </div>

        <Suspense fallback={<div className="card p-8 text-center text-text-secondary"><Loader2 className="w-6 h-6 animate-spin mx-auto" /></div>}>
          <LoginForm />
        </Suspense>
      </div>
    </div>
