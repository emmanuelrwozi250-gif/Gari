...
const SECTIONS = [
  ...
  {
    title: '3. RURA Commercial Vehicle Compliance',
    body: `All vehicles listed on Gari must hold a valid RURA commercial vehicle license with "TM" (transport en commun) registration plates as required by Rwanda's transport regulations (Ministerial Order on Road Transport). Gari verifies commercial licensing documentation before activating any listing on the Platform. Private (non-commercial) vehicles are not permitted under any circumstances. Operators are solely responsible for maintaining valid commercial insurance and renewing their RURA licenses before expiry. Gari reserves the right to immediately suspend or permanently remove any listing where compliance documents have lapsed, without notice or refund of any platform fees paid.`,
  },
  {
